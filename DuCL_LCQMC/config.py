...
def get_parser():
    ...
    # 参数
    parser.add_argument("--num_epoch_pair", default=50, type=int, help=f"the number of epochs of pair_model on LCQMC is 5.")
    ...
    parser.add_argument("--lr_bert", default=1e-5, type=float, help=f"lr_bert on {data} is 2e-5", required=True)
    parser.add_argument("--dropout_rate", default=0.3, type=float, required=True)

    parser.add_argument("--balance", default=0.5, type=float, required=True)
